...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <h1 className="text-3xl text-gray-300 text-center mt-48 mb-16 font-bold underline underline-offset-8 decoration-yellow-300 -rotate-2 ">
        Projects 🚀
      </h1>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-yellow-300 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
