  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg font-semibold md:text-4xl mb-4 text-slate-200  max-w-4xl">
          Changelog from my <strong> Projects</strong>
        </h2>
        <p className="text-neutral-400  text-sm md:text-base max-w-sm">
          I&apos;ve been working on my frontend carrer for the past 3 years.
          Here&apos;s a timeline of my projects.
        </p>
      </div>
